...
const Footer = () => {
  return (
    ...
    <footer className="bg-gray-900 text-white">
        <div className="md:flex md:jutify-betweenmd:items-center sm:px-12 px-4 bg-[#ffffff19] py-7">
            <div className="w-2/5 mx-auto">
                <Link href="https:deluccis.com">
                    <a className="hidden md:flex lg:flex lg:mt-4 ml-15 lg:ml-0 flex-center">
                    <Image src="/images/ds.png"  width={100} height={100} />
                    </a>
                </Link>
            </div>
            <div className="w-4/5 lg:w-2/5 mx-auto">
                <h1 className="text-xl md:mb-0  lg:mb-6 font-semibold md:w-4/5">
                    <span className="text-[#f3f3bf]">Free</span> until you're ready to launch
                </h1>
                <div className="flex">
                    <div className="bg-gray-200 border-2 border-slate-400 rounded lg:flex items-center px-2  mt-3 w-full sm:w-[300px] lg:w-[400px] h-10">
                        <input type="text" placeholder="Enter your details" className="bg-transparent p-2 w-full border-none focus:outline-none"  />
                    </div>
                    <div className="flex space-x-2 h-10 mt-3 justify-center">
                        <button type="button" className="inline-block px-6  md:w-auto w-full py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Button</button>
                    </div>
                </div>
            </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16">
            <div className=''>
                <h1 className='uppercase mb-1 font-semibold'>company</h1>
                <ul>
                    <li>
                        <Link href="/">
                            <a className='text-gray-400 hover:text-teal-400 duration-300 text-sm leading-6'>Home</a>
                        </Link>
                    </li>
                    <li>
                        <Link href="/">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-center pt-2 text-gray-400 text-sm pb-2">
            <span>@ 2022 Deluccis. All rights reserved</span>
            <span>Terms & Privacy Policy</span>
            <div className="text-teal-500 flex items-center justify-center pb-4">
